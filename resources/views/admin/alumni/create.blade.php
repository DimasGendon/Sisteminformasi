                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('jurusan') is-invalid @enderror" id="jurusan"
                            ...
                            <option value="Pengembangan Perangkat Lunak dan Gim"
                                {{ old('jurusan') == 'Pengembangan Perangkat Lunak dan Gim' ? 'selected' : '' }}>PPLG
                            </option>
                            <option value="Desain Komunikasi Visual"
                                {{ old('jurusan') == 'Desain Komunikasi Visual' ? 'selected' : '' }}>DKV</option>
                            <option value="Akuntansi" {{ old('jurusan') == 'Akuntansi' ? 'selected' : '' }}>AK</option>
                            <option value="Manajemen Perkantoran"
                                {{ old('jurusan') == 'Manajemen Perkantoran' ? 'selected' : '' }}>MP</option>
                            <option value="Perhotelan" {{ old('jurusan') == 'Perhotelan' ? 'selected' : '' }}>PH
                            </option>
                            <option value="Bisnis Digital" {{ old('jurusan') == 'Bisnis Digital' ? 'selected' : '' }}>
                                BD</option>
                        </select>
                        @error('jurusan')
                            <div class="invalid-feedback">{{ $message }}</div>
