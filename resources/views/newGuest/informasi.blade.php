...
@section('informasi')
    ...
    <style>
        ...
        .is-icon-reveal {
            display: flex;
            flex-shrink: 0;
            /* Pastikan tidak ada bagian yang menyusut */
        ...
        .box-title {
            ...
            line-height: 1.2;
            height: 4.3em;
            /* Menjaga tinggi judul tetap konsisten */
            display: -webkit-box;
            -webkit-line-clamp: 3;
            /* Batasi teks hanya 3 baris */
        ...
        .box-content {
            ...
            display: -webkit-box;
            -webkit-line-clamp: 7;
            /* Membatasi jumlah baris, sesuaikan jika perlu */
            -webkit-box-orient: vertical;
            /* Membuat box fleksibel secara vertikal */
            height: 7em;
            /* Tentukan tinggi tetap untuk deskripsi */
        }

        /* Agar ikon centang tetap berada di bawah */
        .is-icon-reveal {
            margin-top: auto;
            /* Posisikan ikon centang ke bawah */
            display: flex;
            justify-content: center;
            align-items: center;
            height: 40px;
            /* Pastikan ikon memiliki tinggi yang konsisten */
        }
        ...
        @media (max-width: 480px) {
            .columns.is-vcentered.is-multiline.has-text-centered {
                ...
                /* 1 card per baris untuk layar ponsel */
            }
