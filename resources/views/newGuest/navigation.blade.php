<div class="side-navigation-menu">
    ...
    <div class="category-menu-wrapper">
        ...
        <ul class="categories">
            <li class="square-logo">
                <img src="{{ asset('newTemplate/assets/img/logos/square-white.svg') }}" alt="" />
            </li>
        ...
        <ul class="author">
            <li>
                ...
                <a href="https://cssninja.io">
                    <img class="main-menu-author" src="{{ asset('newTemplate/assets/img/logos/cssninja.svg') }}" alt="" />
                </a>
            </li>
        </ul>
    </div>
    ...
    <div id="demo-pages" class="navigation-menu-wrapper animated preFadeInRight fadeInRight">
        ...
        <ul class="navigation-menu">
            ...
            <li class="has-children">
                <a class="parent-link" href="#"><span
                        class="material-icons">wb_incandescent</span>Startup</a>
                <ul>
            ...
            <li class="has-children">
                <a class="parent-link" href="#"><span
                        class="material-icons">voice_chat</span>Videoconference</a>
                <ul>
                    <li>
            ...
            <li class="has-children">
                <a class="parent-link" href="#"><span
                        class="material-icons">shopping_cart</span>Ecommerce</a>
                <ul>
    ...
    <div id="onepagers" class="navigation-menu-wrapper animated preFadeInRight fadeInRight is-hidden">
        ...
        <ul class="navigation-menu">
            ...
            <li class="has-children">
                <a class="parent-link has-new" href="#"><span
                        class="material-icons">domain</span>Company</a>
                <ul>
            ...
            <li class="has-children">
                <a class="parent-link has-new" href="#"><span class="material-icons">highlight</span>Error
                    Pages</a>
                <ul>
        ...
        <ul class="navigation-menu">
            ...
            <li class="has-children">
                ...
                <ul>
                    ...
                    <li>
                        <a class="is-submenu" href="/_components-layout-navbar-static-light.html">Static
                            light</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="is-submenu" href="/_components-layout-navbar-static-solid.html">Static
                            solid</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="is-submenu" href="/_components-layout-navbar-double-light.html">Double
                            light</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="has-children">
                <a class="parent-link" href="#"><span
                        class="material-icons">playlist_add_check</span>Basic UI</a>
                <ul>
                    <li>
            ...
            <li class="has-children">
                <a class="parent-link" href="#"><span class="material-icons">playlist_add</span>Advanced
                    UI</a>
                <ul>
                    <li>
