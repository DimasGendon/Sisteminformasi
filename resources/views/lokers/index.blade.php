...
@section('content')
    <div class="container">
        ...
        <a href="{{ 'loker.create' }}" class="btn btn-primary mb-3" data-toggle="modal" data-target="#addLokerModal">
        ...
        <div class="modal fade" id="addLokerModal" tabindex="-1" role="dialog" aria-labelledby="addLokerModalLabel"
            aria-hidden="true">
