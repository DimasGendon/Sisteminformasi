{{-- <style>
    /* Make the background of the footer white and text black */
    #footer {
        background-color: white;
        color: black;
    }

    /* Make the titles and paragraphs in the footer black */
    ...
    /* Style the links in the footer on hover */
    ...
    /* Ensure social icons are also black */
    #footer .social li a {
        color: black;
    }
</style>
